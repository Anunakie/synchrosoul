...
export const metadata: Metadata = {
  ...
  title: {
    default: 'SynchroSoul — Angel Number Synching & Spiritual Healing App',
    template: '%s | SynchroSoul',
  },
  description: 'Synch your soul through angel numbers, AI dream readings, and healing music. Log 1111, 555, 333 and connect with spiritually aligned people on your cosmic frequency. Free numerology readings, dream journal, and soul synching.',
  keywords: [
    'angel numbers', 'angel number app', 'spiritual healing app', 'numerology app',
    '1111 meaning', '555 meaning', '333 meaning', '444 meaning', '777 meaning',
    'twin flame', 'soul mate', 'spiritual connection', 'soul synching',
    'angel number synching', 'cosmic connection', 'life path number', 'soul urge number',
    ...
    'healing music', 'spiritual wellness', 'divine guidance', 'sacred numbers',
    'numerology reading', 'soul path', 'destiny number', 'angel number meaning',
    'dream interpretation', 'AI oracle', 'spiritual growth',
  ],
  authors: [{ name: 'SynchroSoul', url: siteUrl }],
  creator: 'SynchroSoul',
  publisher: 'SynchroSoul',
  category: 'Lifestyle',
  classification: 'Spiritual Wellness & Numerology',
  ...
  openGraph: {
    ...
    title: 'SynchroSoul — Angel Number Synching & Spiritual Healing',
    description: 'Log the angel numbers you see. Synch with souls on your cosmic frequency. Discover healing music, AI dream readings, and connect with spiritually aligned people.',
    images: [
      {
        url: `${siteUrl}/og-image.png`,
        width: 1200,
        height: 630,
        alt: 'SynchroSoul — Spiritual Healing & Soul Synching App',
        type: 'image/png',
      },
    ],
  },
  twitter: {
    ...
    site: '@synchrosoul',
    creator: '@synchrosoul',
    title: 'SynchroSoul — Soul Synching & Healing',
    description: 'Synch with souls on your cosmic frequency. Angel numbers, AI dream readings, healing music, and spiritual connection.',
    ...
    "@graph": [
      {
        ...
        "url": siteUrl,
        "name": "SynchroSoul",
        "description": "Angel Number Synching & Spiritual Healing App",
        "potentialAction": {
          "@type": "SearchAction",
          "target": {
            "@type": "EntryPoint",
