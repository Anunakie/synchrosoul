...
function DashboardInner({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'transparent', paddingBottom: '5rem', position: 'relative', overflowX: 'hidden', maxWidth: '100vw' }}>
      ...
      <header style={{ position: 'sticky', top: 0, zIndex: 50, background: 'rgba(5,5,16,0.75)', backdropFilter: 'blur(20px)', borderBottom: '1px solid rgba(200,180,255,0.08)', padding: '0 0.75rem', height: '3.5rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', overflow: 'hidden', maxWidth: '100vw', boxSizing: 'border-box' }}>
