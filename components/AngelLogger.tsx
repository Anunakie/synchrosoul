    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          background: lastLog.readingColor + '22',
          color: lastLog.readingColor,
          border: `1px solid ${lastLog.readingColor}44`,
        ...
        <div style={{ display: 'flex', gap: '0.75rem', justifyContent: 'center' }}>
          ...
          <a href="/dashboard/journal" style={{
            ...
            color: 'rgba(200,180,255,0.6)', cursor: 'pointer', fontSize: '0.875rem',
    ...
    return (
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
          ...
          <div>
            <div style={{
              ...
              borderRadius: '9999px', fontSize: '0.875rem', fontWeight: 700, letterSpacing: '0.1em',
              background: (meaning?.color || '#fff') + '22',
              color: meaning?.color || '#fff',
        ...
        <div style={{ marginBottom: '1.25rem' }}>
          ...
          />
          <p style={{ fontSize: '0.7rem', color: 'rgba(200,180,255,0.25)', marginTop: '0.25rem' }}>Optional · 100% private</p>
        </div>
        ...
        <div style={{ marginBottom: '1.5rem' }}>
          ...
          {screenshot ? (
            <div style={{
              ...
              <div style={{ flex: 1 }}>
                <p style={{ color: '#44ffaa', fontSize: '0.75rem', fontWeight: 500 }}>✓ Angel Approved</p>
            ...
            }}>+ Upload screenshot (optional)</button>
          )}
        </div>
        ...
        <button onClick={handleSave} disabled={saving} style={{
          ...
          border: '1px solid rgba(200,150,255,0.4)',
          color: 'rgba(230,210,255,0.95)', cursor: saving ? 'not-allowed' : 'pointer',
